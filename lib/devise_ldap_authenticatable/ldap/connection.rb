    ...
    class Connection
      ...
      def initialize(params = {})
        ...
        if ldap_config["ssl"]
          ...
          elsif ldap_config["ssl"].is_a? Hash
            ldap_options[:encryption] = ldap_config["ssl"].symbolize_keys
            ldap_options[:encryption][:method] = ldap_options[:encryption][:method].to_sym
          else
            ldap_options[:encryption][:method] = ldap_config["ssl"].to_sym
          end
        end
